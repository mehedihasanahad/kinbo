        ...
        <div class="lg:col-span-3">
            <div class="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm">
                ...
                <form method="POST" action="{{ route('page.contact.send') }}" class="space-y-5">
                    ...
                    <button type="submit"
                            class="w-full bg-primary-600 hover:bg-primary-700 text-white font-semibold py-3 rounded-xl transition-colors text-sm flex items-center justify-center gap-2 cursor-pointer">
