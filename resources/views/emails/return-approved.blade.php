...
<p class="lead">Great news! Your return request for order <strong>{{ $order->order_number }}</strong> has been <strong style="color:#c4155c;">approved</strong>.</p>
...
<div class="card card-neutral" style="margin-top:16px;">
    <p style="font-size:13px;color:#374151;font-weight:600;padding-top:6px;">Note from our team:</p>
...
<hr class="divider">
<p class="help-text">Thank you for shopping with {{ config('app.name') }}. We're sorry for any inconvenience.</p>
@endsection
