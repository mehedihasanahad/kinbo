...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; background: #fdf8f5; color: #18181b; line-height: 1.6; }
        .wrapper { max-width: 600px; margin: 32px auto; background: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 12px rgba(253,108,1,.10); }

        /* Header */
        .header { background: #FD6C01; padding: 32px 36px; text-align: center; }
        ...
        /* Info Card */
        .card { background: #fff7f0; border: 1px solid #fed7b0; border-radius: 10px; padding: 4px 20px; margin: 20px 0; }
        .card-row { display: flex; justify-content: space-between; align-items: center; padding: 10px 0; border-bottom: 1px solid #ffe8d1; font-size: 14px; }
        .card-row:last-child { border-bottom: none; }
        .card-row .label { color: #9ca3af; }
        .card-row .value { font-weight: 600; color: #111827; text-align: right; }
        .card-row .value.total { color: #FD6C01; font-size: 16px; }
        ...
        .table th { background: #fff7f0; text-align: left; padding: 10px 14px; font-weight: 700; color: #a0420a; border-bottom: 2px solid #fed7b0; font-size: 12px; text-transform: uppercase; letter-spacing: .4px; }
        .table td { padding: 10px 14px; border-bottom: 1px solid #ffe8d1; color: #374151; vertical-align: top; }
        ...
        .badge-brand { background: #ffe8d1; color: #cc560a; }

        /* CTA Button */
        .btn { display: inline-block; background: #FD6C01; color: #ffffff !important; text-decoration: none; padding: 13px 32px; border-radius: 8px; font-weight: 700; font-size: 14px; letter-spacing: .3px; margin: 20px 0; }
        .btn-gray { background: #6b7280 !important; }
        .btn-danger { background: #dc2626 !important; }

        /* Misc */
        .divider { border: none; border-top: 1px solid #ffe8d1; margin: 24px 0; }
        .section-title { font-size: 11px; font-weight: 800; text-transform: uppercase; letter-spacing: 1px; color: #cc560a; margin-bottom: 12px; }
        .help-text { font-size: 13px; color: #6b7280; line-height: 1.7; }

        /* Footer */
        .footer { background: #1a0d00; padding: 24px 36px; text-align: center; }
        .footer-links { margin-bottom: 10px; }
        .footer-links a { color: #fed7b0; text-decoration: none; font-size: 13px; font-weight: 600; margin: 0 10px; }
