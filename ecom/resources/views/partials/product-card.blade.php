...
<a href="{{ route('product.show', $productSlug) }}"
   class="product-card bg-white rounded-2xl overflow-hidden border border-gray-100
    ...
    <div class="product-card-image relative bg-gray-50 overflow-hidden">
        ...
        <button class="absolute top-2.5 right-2.5 w-8 h-8 bg-white/90 hover:bg-white rounded-full
    ...
    {{-- ── Card body (flex-grow, keeps button pinned to bottom) ── --}}
    <div class="product-card-body">
        ...
        {{-- Price + Add to Cart — always pinned to bottom --}}
        <div class="product-card-footer flex items-center justify-between gap-2">
            ...
            <button class="shrink-0 bg-primary-600 hover:bg-primary-700 active:bg-primary-800
