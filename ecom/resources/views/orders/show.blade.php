...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-8">
        <div>
            <h1 class="text-xl font-bold text-gray-900">{{ __('front.order_number') }}{{ $order->order_number }}</h1>
    ...
    <div class="bg-white border border-gray-100 rounded-2xl overflow-hidden mb-6">
        ...
        {{-- Shipping address + Payment info (side by side on desktop) --}}
        <div class="grid sm:grid-cols-2 divide-y sm:divide-y-0 sm:divide-x divide-gray-100">
            ...
            <div class="p-6">
                <h2 class="text-sm font-bold text-gray-900 mb-3">{{ __('front.payment_info') }}</h2>
    ...
    @if($order->statusHistory->count() > 0)
        <div class="bg-white border border-gray-100 rounded-2xl p-6 mb-6">
            <h2 class="text-sm font-bold text-gray-900 mb-5">{{ __('front.order_timeline') }}</h2>
            <div class="space-y-4">
